  ...
  public seed() {
    ...
    const sampleMatches: Match[] = [
      ...
      },
      {
        ...
        kickoffTime: '16:30',
        status: 'OPEN',
        description: 'Duelo emocionante do Provincial de Sofala.',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
        markets: [
          {
            ...
            status: 'OPEN',
            selections: [
              { id: 'sel-9-1-1', marketId: 'mkt-9-1', outcome: '1', label: 'Liga Desportiva de Sofala', odds: 1.80, status: 'ACTIVE' },
              { id: 'sel-9-1-X', marketId: 'mkt-9-1', outcome: 'X', label: 'Empate', odds: 3.40, status: 'ACTIVE' },
              { id: 'sel-9-1-2', marketId: 'mkt-9-1', outcome: '2', label: 'Sporting Clube da Beira', odds: 4.10, status: 'ACTIVE' },
            ],
          },
        ],
      },
      {
        id: 'match-10',
        competitionId: 'comp-prov-manica',
        competitionName: 'Campeonato Provincial de Manica',
        competitionCategory: 'PROVINCIAL',
        homeTeam: 'Textáfrica de Chimoio',
        awayTeam: 'Estrela Vermelha de Manica',
        kickoffDate: 'Hoje',
        kickoffTime: '15:00',
        status: 'OPEN',
        description: 'Clássico da província de Manica no Campo do Textáfrica.',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
        markets: [
          {
            ...
            status: 'OPEN',
            selections: [
              { id: 'sel-10-1-1', marketId: 'mkt-10-1', outcome: '1', label: 'Textáfrica de Chimoio', odds: 1.65, status: 'ACTIVE' },
              { id: 'sel-10-1-X', marketId: 'mkt-10-1', outcome: 'X', label: 'Empate', odds: 3.60, status: 'ACTIVE' },
              { id: 'sel-10-1-2', marketId: 'mkt-10-1', outcome: '2', label: 'Estrela Vermelha de Manica', odds: 4.50, status: 'ACTIVE' },
            ],
          },
        ],
      },
      {
        id: 'match-11',
        competitionId: 'comp-prov-maputo',
        competitionName: 'Campeonato Provincial de Maputo',
        competitionCategory: 'PROVINCIAL',
        homeTeam: 'Costa do Sol B',
        awayTeam: 'Matchedje de Maputo',
        kickoffDate: 'Hoje',
        kickoffTime: '17:30',
        status: 'OPEN',
        description: 'Provincial de Maputo no campo principal.',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
        markets: [
          {
            ...
            status: 'OPEN',
            selections: [
              { id: 'sel-11-1-1', marketId: 'mkt-11-1', outcome: '1', label: 'Costa do Sol B', odds: 2.10, status: 'ACTIVE' },
              { id: 'sel-11-1-X', marketId: 'mkt-11-1', outcome: 'X', label: 'Empate', odds: 3.20, status: 'ACTIVE' },
              { id: 'sel-11-1-2', marketId: 'mkt-11-1', outcome: '2', label: 'Matchedje de Maputo', odds: 3.00, status: 'ACTIVE' },
            ],
          },
        ],
      },
      {
        ...
        competitionCategory: 'DISTRITAL',
        homeTeam: 'Desportivo do Dondo',
        awayTeam: 'Ferroviário do Dondo',
        kickoffDate: 'Hoje',
        kickoffTime: '15:30',
        status: 'OPEN',
        description: 'Derby distrital no Dondo.',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
        markets: [
          {
            ...
            status: 'OPEN',
            selections: [
              { id: 'sel-12-1-1', marketId: 'mkt-12-1', outcome: '1', label: 'Desportivo do Dondo', odds: 2.30, status: 'ACTIVE' },
              { id: 'sel-12-1-X', marketId: 'mkt-12-1', outcome: 'X', label: 'Empate', odds: 3.10, status: 'ACTIVE' },
              { id: 'sel-12-1-2', marketId: 'mkt-12-1', outcome: '2', label: 'Ferroviário do Dondo', odds: 2.80, status: 'ACTIVE' },
            ],
          },
        ],
      },
      {
        id: 'match-13',
        competitionId: 'comp-dist-nhamatanda',
        competitionName: 'Campeonato Distrital de Nhamatanda',
        competitionCategory: 'DISTRITAL',
        homeTeam: 'Sporting de Nhamatanda',
        awayTeam: 'Estrela de Nhamatanda',
        kickoffDate: 'Hoje',
        kickoffTime: '15:00',
        status: 'OPEN',
        description: 'Distrital de Nhamatanda.',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
        markets: [
          {
            ...
            status: 'OPEN',
            selections: [
              { id: 'sel-13-1-1', marketId: 'mkt-13-1', outcome: '1', label: 'Sporting de Nhamatanda', odds: 1.95, status: 'ACTIVE' },
              { id: 'sel-13-1-X', marketId: 'mkt-13-1', outcome: 'X', label: 'Empate', odds: 3.30, status: 'ACTIVE' },
              { id: 'sel-13-1-2', marketId: 'mkt-13-1', outcome: '2', label: 'Estrela de Nhamatanda', odds: 3.50, status: 'ACTIVE' },
            ],
          },
        ],
      },
      {
        id: 'match-14',
        competitionId: 'comp-dist-marromeu',
        competitionName: 'Campeonato Distrital de Marromeu',
        competitionCategory: 'DISTRITAL',
        homeTeam: 'Açucareira de Marromeu',
        awayTeam: 'Desportivo de Marromeu',
        kickoffDate: 'Hoje',
        kickoffTime: '16:00',
        status: 'OPEN',
        description: 'Distrital de Marromeu.',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
        markets: [
          {
            ...
            status: 'OPEN',
            selections: [
              { id: 'sel-14-1-1', marketId: 'mkt-14-1', outcome: '1', label: 'Açucareira de Marromeu', odds: 2.15, status: 'ACTIVE' },
              { id: 'sel-14-1-X', marketId: 'mkt-14-1', outcome: 'X', label: 'Empate', odds: 3.10, status: 'ACTIVE' },
              { id: 'sel-14-1-2', marketId: 'mkt-14-1', outcome: '2', label: 'Desportivo de Marromeu', odds: 3.10, status: 'ACTIVE' },
            ],
          },
        ],
      },
